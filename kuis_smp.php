  ...
  <body>
    ...
    <script>
      const questions = [
            ...
            {
                text: "Sederhanakan ekspresi berikut: 3a + 4b - 2a + b.",
                options: ["a + 5b", "a + 3b", "a + 6b", "2a + 5b"],
                answer: "a + 5b",
            },
            {
                text: "Jika 2y + 3 = 17, berapakah nilai y?",
                options: [
                    "y = 5", "y = 6", "y = 7", "y = 8",
                ],
                answer: "y = 7",
            ...
            {
                text: "Rina memiliki tiga kali jumlah kelereng Dimas dikurangi 5. Jika jumlah kelereng Dimas adalah d, maka berapa banyak kelereng Rina dalam bentuk aljabar?",
                options: ["5 - 3d", "3d + 5", "3d - 5", "3d"],
                answer: "3d - 5",
            },
            {
                text: "Jika 4x - 7 = 2x + 9, maka nilai x adalah...",
                options: [
                    "x = 6", "x = 8", "x = 5", "x = 9",
                ],
                answer: "x = 8",
...
document.getElementById("submitBtn").addEventListener("click", function () {
  ...
  const countdownInterval = setInterval(() => {
    ...
    if (countdown < 0) {
      ...
      window.location.href = "dashboard_smp.php"; // Redirect ke beranda
    }
  }, 1000);
});
...
function simpanHasilKuis() {
  ...
  setTimeout(() => {
    window.location.href = "dashboard_smp.php";
  }, 2000);
}
