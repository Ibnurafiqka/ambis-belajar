...
<html lang="id">
  <head>
    ...
    background: url("https://img.youtube.com/vi/1gG1Md4EV3U/maxresdefault.jpg") center center / cover;
    border-radius: 15px;
    cursor: pointer;
}
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="dashboard_sma.php"
              ><i class="fas fa-home"></i> Home</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="materi_sma.php"
    ...
    <div class="main-container">
      ...
      <div class="video-section">
        ...
        width="100%"
        height="100%"
        src="https://www.youtube.com/embed/1gG1Md4EV3U?autoplay=1"
        frameborder="0"
    ...
    ></iframe>
        ...
        <div class="content-container" id="topicContent">
          <h3>Materi Integral - SMA</h3>
          <div class="topic-description">
            <p id="textContent" class="collapsed">
            Integral adalah konsep dalam matematika yang digunakan untuk mengukur akumulasi atau jumlah dari suatu hal yang terus menerus berubah. Dalam kalkulus, integral sering digunakan untuk menghitung luas di bawah kurva, volume benda yang memiliki bentuk melengkung, atau jumlah total dari sesuatu yang terkumpul seiring waktu.

Pada dasarnya, integral adalah cara untuk menjumlahkan banyak elemen kecil secara kontinu. Misalnya, jika kita ingin menghitung luas di bawah suatu grafik, kita bisa membagi luas tersebut menjadi bagian-bagian kecil, menghitung luas masing-masing, dan menjumlahkannya. Semakin kecil bagian yang kita ambil, semakin akurat hasilnya. Proses menjumlahkan elemen-elemen kecil ini adalah konsep inti dari integral.
<br><br>
Ada dua jenis integral utama: <br>
1. Integral Tak Tentu Integral tak tentu tidak memiliki batas awal dan akhir. Hasil dari integral ini adalah fungsi baru yang menunjukkan cara nilai dari suatu fungsi dapat berubah seiring perubahan variabel. <br>

2. Integral Tentu Integral tertentu memiliki batas awal dan akhir, dan hasilnya adalah angka pasti. Integral ini digunakan untuk menghitung jumlah total dari suatu hal antara dua titik, seperti luas di bawah kurva dari titik \( a \) ke titik \( b \).

Integral digunakan dalam banyak aplikasi praktis. Dalam fisika, misalnya, integral dapat digunakan untuk menghitung jarak yang ditempuh oleh suatu objek ketika kita tahu kecepatannya yang terus berubah. Dalam ekonomi, integral bisa digunakan untuk menghitung keuntungan total selama periode tertentu ketika keuntungan berubah setiap saat. Integral juga digunakan dalam teknik untuk menghitung beban total, gaya total, atau energi total dalam sistem yang kompleks.

Integral adalah kebalikan dari turunan. Jika turunan menggambarkan bagaimana sesuatu berubah pada setiap titik, integral menggambarkan akumulasi atau total dari perubahan itu seiring waktu atau ruang.
    ...
    <script>
      ...
      function changeSection(newSection) {
        ...
        if (newSection === 2) {
          ...
          window.location.href = "topik_materi_sma.php";
          return;
