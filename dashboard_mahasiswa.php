...
$stmt_materi = $pdo->prepare("SELECT * FROM materi WHERE level = 'Mahasiswa' ORDER BY created_at DESC LIMIT 5");
// $stmt_materi->execute();
  ...
  <body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="resourcesDropdown">
              ...
              <a class="dropdown-item" href="forum_diskusi.php"
                >Forum Diskusi</a
              >
              <a class="dropdown-item" href="stream_new.php">Stream</a>
            </div>
          </li>
          <li>
          ...
          <li class="nav-item dropdown">
            ...
            >
              <a class="dropdown-item" href="profile_mahasiswa.php">Profil Saya</a>
              <a class="dropdown-item" href="setting_mahasiswa.php">Pengaturan</a>
    ...
    <div class="main-container">
      ...
      <aside class="sidebar">
        ...
        <a href="kuis.php"><i class="fas fa-clipboard-list"></i> Kuis</a>
        <a href="forum_diskusi.php"
          ><i class="fas fa-comments"></i> Forum Diskusi</a
        >
        <a href="stream_new.php"><i class="fas fa-video"></i> Study Stream</a>
      </aside>
      ...
      <div class="content">
        ...
        <div class="stats-grid">
          <div class="stat-card">
            ...
            <div class="stat-value">24 <i class="fas fa-book"></i></div>
          </div>
          <div class="stat-card">
          ...
          <div class="stat-card">
            ...
            <div class="stat-value">300 <i class="fas fa-star"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Achievement</div>
            <div class="stat-value">5 <i class="fas fa-trophy"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Streak Hari Belajar</div>
            <div class="stat-value">7 Hari <i class="fas fa-fire"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Total Point</div>
            <div class="stat-value">1500 <i class="fas fa-coins"></i></div>
          </div>
        </div>
    ...
    <script>
      ...
      const statHistory = {
        "Materi Dibaca":
          "Anda telah membaca total 24 materi, dengan peningkatan konsistensi membaca 30% dalam minggu terakhir.",
        "Kuis Diselesaikan":
          "Anda telah menyelesaikan 15 kuis dengan skor rata-rata 85%, dan peningkatan skor pada kuis terakhir sebesar 10%.",
        "XP Terkumpul":
          "XP Anda saat ini adalah 300, yang diraih dari kuis dan membaca materi.",
        Achievement:
          "Anda telah meraih 5 achievement, termasuk 'Pembaca Aktif' dan 'Penakluk Kuis'.",
        "Streak Hari Belajar":
          "Anda memiliki 7 hari berturut-turut belajar. Pertahankan streak untuk mendapatkan bonus XP!",
        "Total Point":
          "Anda telah mengumpulkan 1500 poin total dari semua aktivitas pembelajaran Anda.",
      };
