    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="dashboard_smp.php"
              ><i class="fas fa-home"></i> Home</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="setting_smp.php"
    ...
    <div class="main-container">
      <div class="profile-header">
        <div class="profile-picture-container">
          <div class="profile-picture">
            <img
              src="https://asset.kompas.com/crops/PXyK_WFF8OOHeoeZlwAAIDXNxHw=/5x0:529x350/750x500/data/photo/2021/04/02/60668c320fe72.png"
              alt="Foto Profil"
            />
          </div>
          <div class="profile-edit">
            <a href="setting_smp.php">Edit</a>
          </div>
        </div>
      ...
      <div class="bio-container" id="bioContent">
        ...
        <div class="topic-description">
          ...
          Saya adalah seorang siswa SMP yang antusias belajar matematika dan geologi. Saya memiliki ketertarikan mendalam pada dunia sains, terutama mengenai struktur bumi dan fenomena geologi yang menarik. Selain itu, saya senang memecahkan soal-soal matematika dan selalu ingin memahami konsep-konsep baru. Dengan semangat belajar yang tinggi, saya sering mengikuti kegiatan ekstrakurikuler dan proyek-proyek kecil untuk memperdalam pengetahuan saya, baik di bidang matematika maupun geologi. Saya percaya bahwa dengan mempelajari lebih banyak tentang bumi dan angka, saya akan lebih siap untuk memahami dunia di sekitar kita.
          </p>
      ...
      <div class="progress-section">
        ...
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 45%">45%</div>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 37%">37%</div>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 66%">66%</div>
        </div>
      </div>
      ...
      <div class="achievement-grid">
        <div class="achievement-card">
          ...
          <div class="achievement-info">
            <h4>Pemenang Olimpiade Matematika</h4>
            <p>Juara pertama dalam olimpiade matematika.</p>
          </div>
        </div>
        <div class="achievement-card">
          <div class="achievement-icon"><i class="fas fa-certificate"></i></div>
          <div class="achievement-info">
            <h4>Sertifikat Olahraga Boxing</h4>
            <p>Partisipasi magang olimpiade Paris.</p>
          </div>
        </div>
      </div>
    </div>
