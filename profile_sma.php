    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="setting_sma.php"
    ...
    <div class="main-container">
      <div class="profile-header">
        <div class="profile-picture-container">
          <div class="profile-picture">
            <img
              src="https://cdn.idntimes.com/content-images/community/2024/03/430895438-994640495365753-3117201511338688591-n-f424d03806edcc13f730af30854e7bc3-9dd70c6e055297492bb74b348cff2e70.jpg"
              alt="Foto Profil"
            />
          </div>
          <div class="profile-edit">
            <a href="setting_sma.php">Edit</a>
          </div>
        </div>
        <div class="profile-info">
          ...
          <div class="tags">
            ...
            <span class="tag">Biologychal</span>
      ...
      <div class="bio-container" id="bioContent">
        ...
        <div class="topic-description">
          <p id="textContent" class="collapsed">
            Saya adalah seorang siswa SMA yang aktif dalam olimpiade sains dan sedang berjuang untuk lolos SNBP. Saya memiliki ketertarikan mendalam pada pengembangan teknologi, khususnya dalam pengembangan web. Saya senang mempelajari bahasa pemrograman seperti HTML, CSS, dan JavaScript, serta berbagai framework yang digunakan dalam pembuatan website dan aplikasi. <br /><br />
            Dengan semangat belajar yang tinggi, saya sering terlibat dalam proyek-proyek kecil untuk mengasah keterampilan coding saya dan bekerja sama dengan teman-teman. Saya percaya bahwa pemahaman teknologi web akan sangat berguna di dunia yang semakin digital ini. Melalui latihan praktis dan eksperimen, saya berkomitmen untuk menjadi pengembang web yang handal dan siap berkontribusi dalam bidang teknologi di masa depan.
          </p>
      ...
      <div class="progress-section">
        ...
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 90%">90%</div>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 95%">95%</div>
        </div>
        <div class="progress-bar">
          <div class="progress-bar-inner" style="width: 93%">93%</div>
        </div>
      </div>
      ...
      <div class="achievement-grid">
        <div class="achievement-card">
          ...
          <div class="achievement-info">
            <h4>Pemenang Top Skor SNBP</h4>
            <p>Juara pertama dalam skor SNBP.</p>
          </div>
        </div>
        <div class="achievement-card">
          <div class="achievement-icon"><i class="fas fa-certificate"></i></div>
          <div class="achievement-info">
            <h4>Sertifikat OSN</h4>
            <p>Partisipasi olimpiade sains tingkat nasional.</p>
          </div>
        </div>
      </div>
    </div>
