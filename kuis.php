...
<html lang="id">
  ...
  <body>
    ...
    <script>
      const questions = [
        {
          text: "Apa itu JSX dalam React?",
          options: [
            "A. Sintaks untuk menghubungkan ke database",
            "B. Sintaks untuk mendefinisikan komponen",
            "C. Sintaks mirip HTML untuk mendeskripsikan UI",
            "D. Sintaks untuk menulis CSS",
          ],
          answer: "C. Sintaks mirip HTML untuk mendeskripsikan UI",
        },
        {
          text: "Apa yang digunakan untuk mengelola data yang bersifat lokal dalam suatu komponen?",
          options: [
            "A. Props",
            "B. State",
            "C. Lifecycle methods",
        ...
        {
          text: "Bagaimana cara mendefinisikan komponen kelas di React?",
          options: [
            "A. const Component = () => {}",
          ...
          answer: "C. class Component extends React.Component {}",
        },
        {
          text: "Manakah yang benar tentang props dalam React?",
          options: [
            "A. Props dapat diubah oleh komponen penerima.",
            "B. Props digunakan untuk menyimpan data lokal.",
            "C. Props adalah cara untuk mengirim data antar komponen.",
            "D. Props hanya digunakan dalam komponen kelas.",
          ],
          answer: "C. Props adalah cara untuk mengirim data antar komponen.",
        },
        {
          text: "Apa fungsi dari render() dalam komponen kelas?",
          options: [
            "A. Menyimpan data state",
            "B. Menampilkan UI komponen",
            "C. Mengatur props",
            "D. Menghapus komponen dari DOM",
          ],
          answer: "B. Menampilkan UI komponen",
        },
      ];
...
document.getElementById("submitBtn").addEventListener("click", function () {
  ...
  const countdownInterval = setInterval(() => {
    ...
    if (countdown < 0) {
      ...
      window.location.href = "dashboard_mahasiswa.php"; // Redirect ke beranda
    }
  }, 1000);
});
