        ...
        <div id="exerciseContainer">
          ...
          <div class="exercise-card">
            ...
            <div class="exercise-options">
              <button class="option-btn" data-correct="true">
                <span class="option-text">A. Sebuah pustaka JavaScript untuk membangun antarmuka pengguna</span>
              </button>
              <button class="option-btn">
                <span class="option-text">B. Sebuah framework untuk pengembangan backend</span>
              </button>
              <button class="option-btn">
                <span class="option-text">C. Sebuah bahasa pemrograman</span>
              </button>
              <button class="option-btn">
                <span class="option-text">D. Sebuah pustaka untuk mengelola database</span>
              </button>
            </div>
          ...
          <div class="exercise-card" style="display: none">
            <div class="exercise-question">
              <h4>Latihan 2</h4>
              <p>
                Apa fungsi dari JSX dalam React?
              </p>
            </div>
            <div class="exercise-options">
              <button class="option-btn">
                <span class="option-text">A. Bahasa pemrograman baru untuk React</span>
              </button>
              <button class="option-btn" data-correct="true">
                <span class="option-text">B. Ekstensi sintaks JavaScript yang memungkinkan kita menulis HTML di dalam JavaScript</span>
              </button>
              <button class="option-btn">
                <span class="option-text">C. Format styling khusus yang digunakan dalam React</span>
              </button>
              <button class="option-btn">
                <span class="option-text">D. Sistem manajemen state di React</span>
              </button>
            </div>
    ...
    <script>
      ...
      nextButton.addEventListener("click", () => {
        if (currentExercise < totalExercises - 1) {
          ...
          window.location.href = "kuis.php"; // Redirect to quiz page after last exercise
        }
      });
