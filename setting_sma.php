...
$user = [
  'username' => isset($_SESSION['username']) ? $_SESSION['username'] : 'Guest', // Nama pengguna yang login
  'role' => isset($_SESSION['level']) ? $_SESSION['level'] : 'MAHASISWA'  ,      // Peran pengguna yang login
  'email' => isset($_SESSION['email']) ? $_SESSION['email'] : 'guest@gmail.com'        // Peran pengguna yang login
];
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="profile_sma.php"
    ...
    <div class="settings-layout">
      ...
      <div class="settings-content">
        ...
        <?php if (isset($user) && !is_null($user)): ?>
          ...
          <p>Status: <?php echo htmlspecialchars($user['role']); ?></p>
        <?php else: ?>
          <h3>Username tidak tersedia</h3>
...
Seorang pelajar SMA yang antusias dalam bidang Sains dan Matematika.
              </textarea>
            </div>
