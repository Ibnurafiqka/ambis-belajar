  ...
  <body>
    ...
    <div class="main-container">
      ...
      <div class="exercise-section">
        <h2>Latihan dan Contoh Soal Integral</h2>
        ...
        <div id="exerciseContainer">
          ...
          <div class="exercise-card">
            <div class="exercise-question">
              <h4>Latihan 1</h4>
              <p>Diberikan sebuah fungsi kecepatan konstan dari sebuah mobil yang bergerak selama 5 detik dengan kecepatan 10 meter per detik. Berapakah jarak total yang ditempuh mobil tersebut?</p>
            </div>
            <div class="exercise-options">
              <button class="option-btn" data-correct="true">
                <span class="option-text"3+C>A. 50 meter </span>
              </button>
              <button class="option-btn">
                <span class="option-text">B. 20 meter</span>
              </button>
              <button class="option-btn">
                <span class="option-text">C. 30 meter</span>
              </button>
              <button class="option-btn">
                <span class="option-text">D. 70 meter</span>
              </button>
            </div>
          ...
          <div class="exercise-card" style="display: none">
            <div class="exercise-question">
              <h4>Latihan 2</h4>
              <p>
              Jika diketahui kecepatan air yang mengalir dari sebuah keran adalah 4 liter per menit, <br>berapakah total volume air yang keluar selama 7 menit?
              </p>
            </div>
            <div class="exercise-options">
              <button class="option-btn">
                <span class="option-text">A. 21 liter</span>
              </button>
              <button class="option-btn" data-correct="true">
                <span class="option-text">B. 24 liter</span>
              </button>
              <button class="option-btn">
                <span class="option-text">C. 32 liter</span>
              </button>
              <button class="option-btn">
                <span class="option-text">D. 28 liter</span>
              </button>
            </div>
    ...
    <script>
      ...
      nextButton.addEventListener("click", () => {
        if (currentExercise < totalExercises - 1) {
          ...
          window.location.href = "kuis_sma.php"; // Redirect to quiz page after last exercise
        }
      });
