...
<html lang="id">
  <head>
    ...
    background: url("https://img.youtube.com/vi/s5yk8vg01As/maxresdefault.jpg")
      center center / cover;
    border-radius: 15px;
    cursor: pointer;
    color: #fff;
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="stream_smp.php"
      ...
      <div class="video-section">
        <div class="video-container">
          ...
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://youtu.be/s5yk8vg01As?si=Dm6J0Ynxl8PsWJWd"
            frameborder="0"
        ...
        <div class="content-container" id="topicContent">
          ...
          <div class="topic-description">
            ...
            Aljabar adalah cabang matematika yang melibatkan penggunaan huruf atau simbol untuk mewakili bilangan. Dalam aljabar, kita menggunakan variabel (biasanya berupa huruf seperti 
    x
x atau 
y
y) untuk menggantikan nilai yang belum diketahui atau bisa berubah-ubah. Aljabar membantu dalam menyederhanakan masalah yang rumit menjadi bentuk yang lebih mudah untuk dihitung. <br /><br />
Selain persamaan linear, ada juga konsep seperti penjumlahan dan pengurangan suku sejenis. Suku sejenis adalah suku yang memiliki variabel dan pangkat yang sama. Misalnya, dalam ekspresi 
3
x
+
5
x
3x+5x, kedua suku ini bisa dijumlahkan menjadi 
8
x
8x. Aljabar memberikan dasar yang penting dalam matematika dan membantu siswa berpikir logis serta memecahkan masalah dengan langkah yang sistematis.
            </p>
