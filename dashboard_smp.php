...
if (!isset($_SESSION['user_id']) || $_SESSION['level'] !== 'SMP') {
...
$stmt_materi = $pdo->prepare("SELECT * FROM materi WHERE level = 'SMP' ORDER BY created_at DESC LIMIT 5");
// $stmt_materi->execute();
// $materi_terbaru = $stmt_materi->fetchAll();

// Mengambil quiz terakhir
// $stmt_quiz = $pdo->prepare("SELECT * FROM quiz_results WHERE user_id = ? ORDER BY date_taken DESC LIMIT 3");
...
<html lang="id">
  ...
  <body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="resourcesDropdown">
              <a class="dropdown-item" href="materi_smp.php">Materi</a>
              <a class="dropdown-item" href="kuis_smp.php">Kuis</a>
              <a class="dropdown-item" href="forum_diskusi_smp.php"
                >Forum Diskusi</a
              >
          ...
          <li class="nav-item dropdown">
            ...
            >
              <a class="dropdown-item" href="profile_smp.php">Profil Saya</a>
              <a class="dropdown-item" href="setting_smp.php">Pengaturan</a>
    ...
    <div class="main-container">
      ...
      <aside class="sidebar">
        <h5>Navigation</h5>
        <a href="materi_smp.php"><i class="fas fa-book"></i> Materi</a>
        <a href="kuis_smp.php"><i class="fas fa-clipboard-list"></i> Kuis</a>
        <a href="forum_diskusi_smp.php"
      ...
      <div class="content">
        ...
        <div class="stats-grid">
          <div class="stat-card">
            ...
            <div class="stat-value">10 <i class="fas fa-book"></i></div>
          </div>
          <div class="stat-card">
          ...
          <div class="stat-card">
            ...
            <div class="stat-value">200 <i class="fas fa-star"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Achievement</div>
            <div class="stat-value">3 <i class="fas fa-trophy"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Streak Hari Belajar</div>
            <div class="stat-value">9 Hari <i class="fas fa-fire"></i></div>
          </div>
          <div class="stat-card">
            <div class="stat-title">Total Point</div>
            <div class="stat-value">1200 <i class="fas fa-coins"></i></div>
          </div>
        </div>
        ...
        <ul class="list-group mb-4">
          ...
          >
            Webinar: Pengaruh Kenakalan Remaja
    ...
    <script>
      ...
      const statHistory = {
        "Materi Dibaca":
          "Anda telah membaca total 7 materi, dengan peningkatan konsistensi membaca 20% dalam minggu terakhir.",
        "Kuis Diselesaikan":
          "Anda telah menyelesaikan 5 kuis dengan skor rata-rata 75%, dan peningkatan skor pada kuis terakhir sebesar 10%.",
        "XP Terkumpul":
          "XP Anda saat ini adalah 80, yang diraih dari kuis dan membaca materi.",
        Achievement:
          "Anda telah meraih 3 achievement, termasuk 'Pembaca Ulung' dan 'Pelawan Malas'.",
        "Streak Hari Belajar":
          "Anda memiliki 4 hari berturut-turut belajar. Pertahankan streak untuk mendapatkan bonus XP!",
        "Total Point":
          "Anda telah mengumpulkan 800 poin total dari semua aktivitas pembelajaran Anda.",
      };
